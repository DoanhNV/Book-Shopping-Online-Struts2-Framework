					...
					<ul class="icon1 sub-icon1">
						  ...
						  <div class="shopping_cart">
							  <div class="cart_box">
					                ...
					                <div class="list_img"><img src="home/images/14.jpg" class="img-responsive" alt=""></div>
	                            ...
	                            <div class="cart_box1">
								  <div class="message1">
					                ...
					                <div class="list_img"><img src="home/images/15.jpg" class="img-responsive" alt=""></div>
								    <div class="list_desc"><h4><a href="#">velit esse molestie</a></h4>1 x<span class="actual">
		                             $12.00</span></div>
		                              <div class="clearfix"></div>
	                              </div>
	...
	<div class="banner-mat">
		<div class="container">
			...
			<ul class="rslides" id="slider1">
			  <li><img src="home/images/banner.jpg" alt="">
			  </li>
			  <li><img src="home/images/banner1.jpg" alt="">
			  </li>
			  <li><img src="home/images/banner.jpg" alt="">
			  </li>
			  <li><img src="home/images/banner2.jpg" alt="">
			  </li>
			</ul>
		</div>
				...
				<div class="content-top">
					...
					<div class="content-top-in">
						<div class="col-md-3 md-col">
							<div class="col-md">
								<a href="single.html"><img  src="home/images/pi.jpg" alt="" /></a>	
						...
						<!-- <div class="col-md-3 md-col">
							<div class="col-md">
								<a href="single.html"><img  src="home/images/pi1.jpg" alt="" />	</a>
								<div class="top-content">
						...
						<div class="col-md-3 md-col">
							<div class="col-md">
								<a href="single.html"><img  src="home/images/pi2.jpg" alt="" /></a>	
								<div class="top-content">
						...
						<div class="col-md-3 md-col">
							<div class="col-md">
								<a href="single.html"><img  src="home/images/pi3.jpg" alt="" /></a>	
								<div class="top-content">
